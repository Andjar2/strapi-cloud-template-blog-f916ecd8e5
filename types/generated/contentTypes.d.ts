...
export interface ApiClubPageClubPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    color: Schema.Attribute.String &
      Schema.Attribute.CustomField<'plugin::color-picker.color'>;
    ContentBottom: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMainMenuMainMenu extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    MainMenuItems: Schema.Attribute.DynamicZone<
      ['menu.dropdown', 'menu.link', 'menu.menu-link']
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
